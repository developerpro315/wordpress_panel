...
<div class="layout-head__inner"><div class="layout-head__contents"><div class="order-successful-icon"><img src="https://www.ezrsgold.com/themes/ezrsgold/assets/img/success-icon.png" alt=""></div> <h1 class="layout-head__title">Order #85566 successful</h1> <span class="layout-head__subtitle">
        ...
        <div class="checkout-cart__items">
            <div class="checkout-cart-item">
                ...
                <div class="checkout-cart-item__details">
                    <div class="checkout-cart-item__title">Gold</div> <span class="checkout-cart-item__qty"></span> 20 x<span class="checkout-cart-item__price"></span>7.00<span class="checkout-cart-item__total"></span></div>
            </div>
        </div>
...
<script>
  ...
  const decryptedData = CryptoJS.AES.decrypt(decodedText, key);
  return decryptedData.toString(CryptoJS.enc.Utf8);
}
const encryptionKey = 'mysecretkeyss';
</script>
@endsection