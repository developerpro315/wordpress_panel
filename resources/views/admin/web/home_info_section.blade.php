                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive m-t-10">
                            ...
                            <a class="btn btn-success" href="{{url('panel/admin/home_info/add/')}}" role="button">Add More</a>
                                ...
                                @foreach($HomeInfo as $HomeInfo_)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ url('panel/admin/home_info/view',$HomeInfo_->id) }}"><i class="fas fa-eye"></i></a>
                                            <a href="{{ url('panel/admin/home_info/edit/'.$HomeInfo_->id) }}"><i class="fas fa-edit"></i></a>
                                            <a href="{{ url('panel/admin/home_info/delete',$HomeInfo_->id) }}" onclick='return confirm("Confirm delete?")'><i class="fas fa-trash-alt text-danger"></i></a>
