            ...
            <div class="col-sm-12">
                <div class="white-box card">
                    <div class="card-body">
                        ...
                        <form id="commentForm" action="{{url('panel/admin/account/profile')}}"
                              method="POST" enctype="multipart/form-data">
                        @elseif(auth()->user()->hasRole('user'))
                        <form id="commentForm" action="{{url('panel/User/account/profile')}}" method="POST" enctype="multipart/form-data">
                              @endif
                        @endauth
                            ...
                            <div id="rootwizard">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab1">
                                        {{--<h2 class="hidden">&nbsp;</h2>--}}
                                        <div class="form-group row justify-content-center   {{ $errors->first('firstname', 'has-error') }}">
                                            <label for="firstname" class="col-12 col-lg-2 control-label">First Name *</label>
                                        ...
                                        <div class="form-group row justify-content-center   {{ $errors->first('lastname', 'has-error') }}">
                                            <label for="lastname" class="col-12 col-lg-2 control-label">Last Name *</label>
                                            <div class="col-12 col-lg-6">
                                        ...
                                        <div class="form-group row justify-content-center   {{ $errors->first('email', 'has-error') }}">
                                            ...
                                            <div class="col-12 col-lg-6">
                                                ...
                                                <input id="email" name="email" hidden placeholder="E-mail" type="text"
                                                       class="form-control required email" value="{{$user->email}}"/>
                                    ...
                                    <div class="tab-pane" id="tab2">
                                        ...
                                        <div class="form-group row justify-content-center   {{ $errors->first('phone', 'has-error') }}">
                                            <label for="phone" class="col-12 col-lg-2 control-label">Phone Number</label>
                                            <div class="col-12 col-lg-6">
                                                <input id="countries" name="phone" type="text"
                                                       class="form-control Phone"
                                                       value="@if(!empty($user->profile->phone)) {{$user->profile->phone}} @endif"/>
                                    ...
                                    <div class="tab-pane" id="tab3">
                                        ...
                                        <div class="form-group row justify-content-center   {{ $errors->first('postal', 'has-error') }}">
                                            ...
                                            <div class="col-12 col-lg-6">
                                            <!-- min="1" pattern="\d{1,5}" onKeyPress="if(this.value.length==5) return false;" -->
