...
class PolicyController extends Controller
{
    ...
    {
        $policy_details = CMS::where('page_name','Privacy Policy')->get();
        return view('admin.CMS.policy.index',compact('policy_details'));
    }
    public function edit($id)
    {
        $policy_detail = CMS::findOrFail($id);
        return view('admin.CMS.policy.edit',compact('policy_detail'));
    }

    public function show($id)
    {
        $policy_detail = CMS::findOrFail($id);
        return view('admin.CMS.policy.view',compact('policy_detail'));
    }
    ...
    public function update(Request $request , $id)
    {
        ...
        return redirect('panel/admin/privacy-policy')->with('message', 'Content Has Been Updated!');
    }
