...

{
...

    {
        ...
        $faqs_details = CMS::where('page_name','Faq')->get();

        return view('admin.CMS.Faqs.index',compact('faqs_details'));
...

    {
        ...
        return view('admin.CMS.Faqs.edit',compact('faqs_details'));
...

    {
        ...
        return view('admin.CMS.Faqs.view',compact('faqs_details'));
...

    {
        ...
        return redirect('panel/admin/faqs')->with('message', 'Content Has Been Updated!');
