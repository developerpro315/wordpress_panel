...
class BotiquecmsController extends Controller

{
...

    {
        ...
        $botique_details = CMS::where('page_name','Boutique')->get();

        return view('admin.CMS.Botique.index',compact('botique_details'));
...

    {
        ...
        $botique_details = CMS::findOrFail($id);

        return view('admin.CMS.Botique.edit',compact('botique_details'));
...

    {
        ...
        return view('admin.CMS.Botique.view',compact('botique_details'));
...

    {
        ...
        if ($request->hasfile('image5')) {
            ...
            $destination3 = 'uploads/admin/CMS/'.$imagetable->image5;
            ...
            $file2 = $request->file('image5');

            $extention2 = $file2->getClientOriginalExtension();

            $filename2 = time().'5.'.$extention2;
            ...
            CMS::where('id', $id)
                ...
                ->update([
                    ...
                    'image5' => 'uploads/admin/CMS/'.$filename2,
        ...
        if ($request->hasfile('image6')) {
            ...
            $destination3 = 'uploads/admin/CMS/'.$imagetable->image6;
            ...
            $file2 = $request->file('image6');

            $extention2 = $file2->getClientOriginalExtension();

            $filename2 = time().'6.'.$extention2;
            ...
            CMS::where('id', $id)
                ...
                ->update([
                    ...
                    'image6' => 'uploads/admin/CMS/'.$filename2,
        ...
        return redirect('panel/admin/botique_cms')->with('message', 'Content Has Been Updated!');
