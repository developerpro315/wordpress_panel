...
class TNCController extends Controller
{
    ...
    {
        $tnc_details = CMS::where('page_name','Terms And Conditions')->get();
        return view('admin.CMS.TNC.index',compact('tnc_details'));
    }
    public function edit($id)
    {
        $tnc_detail = CMS::findOrFail($id);
        return view('admin.CMS.TNC.edit',compact('tnc_detail'));
    }

    public function show($id)
    {
        $tnc_detail = CMS::findOrFail($id);
        return view('admin.CMS.TNC.view',compact('tnc_detail'));
    }
    ...
    public function update(Request $request , $id)
    {
        ...
        return redirect('panel/admin/terms-and-conditions')->with('message', 'Content Has Been Updated!');
    }
