...
class ServicesController extends Controller
{
    ...
    {
        $service_details = CMS::where('page_name','Service')->get();
        return view('admin.CMS.Services.index',compact('service_details'));
    }
    public function edit($id)
    {
        $service_details = CMS::findOrFail($id);
        return view('admin.CMS.Services.edit',compact('service_details'));
    }

    public function show($id)
    {
        $service_details = CMS::findOrFail($id);
        return view('admin.CMS.Services.view',compact('service_details'));
    }
    ...
    public function update(Request $request , $id)
    {
        ...
        return redirect('panel/admin/Services')->with('message', 'Content Has Been Updated!');
    }
