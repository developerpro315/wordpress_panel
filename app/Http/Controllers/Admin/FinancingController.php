...

{
...

    {
        ...
        $financing_details = CMS::where('page_name','Financing')->get();

        return view('admin.CMS.Financing.index',compact('financing_details'));
...

    {
        ...
        $financing_details = CMS::findOrFail($id);

        return view('admin.CMS.Financing.edit',compact('financing_details'));
...

    {
        ...
        $faqs_details = CMS::findOrFail($id);

        return view('admin.CMS.Financing.view',compact('faqs_details'));
...

    {
        ...
        return redirect('panel/admin/financing')->with('message', 'Content Has Been Updated!');
