...
class PrivacyPolicyController extends Controller
{
    ...
    {
        $policy_details = CMS::where('page_name','Privacy And Policy')->get();
        return view('admin.CMS.policy.index',compact('policy_details'));
    }
    public function edit($id)
    {
        $policy_details = CMS::findOrFail($id);
        return view('admin.CMS.policy.edit',compact('policy_details'));
    }

    public function show($id)
    {
        $policy_details = CMS::findOrFail($id);
        return view('admin.CMS.policy.view',compact('policy_details'));
    }
